...
<style>
    ...
    .card:hover,
    .card:active {
        transform: scale(1.05); /* Scale up the card slightly on hover/active */
    }
    ...
    .card img {
        ...
        border-radius: 8px; /* Keeps the border radius consistent with the card */
    }
  ...
  <div class="box">
    <a href="fundtransfer.jsp?transferType=RTGS">
      <div class="card">
        ...
        <div class="card-text">
          <img src="rtgs.jpg" alt="Money Transfer" title="Money Transfer">
        </div>
      </div>
    </a>
  </div>
  <div class="box">
    <a href="fundtransfer.jsp?transferType=NEFT">
      <div class="card">
        ...
        <div class="card-text">
          <img src="neft.png" alt="Check Balance" title="Check Balance">
        </div>
      </div>
    </a>
  </div>
  <div class="box">
    <a href="fundtransfer.jsp?transferType=IMPS">
      <div class="card">
        ...
        <div class="card-text">
          <img src="imps.png" alt="Withdraw" title="Withdraw">
        </div>
      </div>
    </a>
  </div>
