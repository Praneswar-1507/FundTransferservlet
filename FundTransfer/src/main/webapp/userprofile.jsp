...
<body>
 ...
 <div id="addBeneficiaryPopup" class="popup">
    <div class="popup-content">
        <button class="close" onclick="closePopup('addBeneficiaryPopup')" aria-label="Close popup">&times;</button>
        <h3>Add Beneficiary</h3>
        <form action="BankAccount" method="post">
            <input type="text" name="beneficiaryName" placeholder="Beneficiary Name" required>
            <input type="text" name="accountID" placeholder="Beneficiary Account ID" pattern="^[0-9]{12}$"  required>
            <input type="text" name="ifscCode" placeholder="IFSC Code" pattern="^([A-Z]{4}[0][A-Z0-9]{6})$" required> 
            <input type="hidden" name="action" value="beneficiary">
